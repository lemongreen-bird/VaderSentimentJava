...
public final class Term implements Comparable<Term>, Accountable {
   ...
   *
   * <p>Note that a null field value results in undefined behavior for most Lucene APIs that accept
   * a Term parameter.
   */
   ...
   *
   * <p>WARNING: the provided BytesRef is not copied, but used directly. Therefore the bytes should
