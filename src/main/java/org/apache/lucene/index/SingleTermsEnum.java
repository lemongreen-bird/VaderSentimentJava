 ...
 *
 * <p>For example, this can be used by {@link MultiTermQuery}s that need only visit one term, but
 * want to preserve MultiTermQuery semantics such as {@link MultiTermQuery#getRewriteMethod}.
 */
public final class SingleTermsEnum extends FilteredTermsEnum {
   ...
   *
   * <p>After calling the constructor the enumeration is already pointing to the term, if it exists.
   */
